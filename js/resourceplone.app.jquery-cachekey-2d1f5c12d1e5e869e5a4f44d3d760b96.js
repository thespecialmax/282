...
// https://bib.kuleuven.be/portal_javascripts/jquery-integration.js?original=1
var jq=jQuery;if(typeof cssQuery==='undefined'){var cssQuery=function(s,f){return jQuery.makeArray(jQuery(s,f))}}


/* - register_function.js - */
// https://bib.kuleuven.be/portal_javascripts/register_function.js?original=1
var bugRiddenCrashPronePieceOfJunk=(navigator.userAgent.indexOf('MSIE 5')!==-1&&navigator.userAgent.indexOf('Mac')!==-1);var W3CDOM=(!bugRiddenCrashPronePieceOfJunk&&typeof document.getElementsByTagName!=='undefined'&&typeof document.createElement!=='undefined');var registerEventListener=function(elem,event,func){jQuery(elem).bind(event,func)};var unRegisterEventListener=function(elem,event,func){jQuery(elem).unbind(event,func)};var registerPloneFunction=jQuery;
function getContentArea(){var node=jQuery('#region-content,#content');return node.length?node[0]:null}


/* - plone_javascript_variables.js - */
// https://bib.kuleuven.be/portal_javascripts/plone_javascript_variables.js?original=1
var portal_url='https://bib.kuleuven.be';var base_url='https://bib.kuleuven.be/english/fbib';var form_modified_message='Het formulier is niet opgeslagen. U dient uw wijzigingen opnieuw in te voeren.';var form_resubmit_message='U heeft al op de verzendingsknop geklikt. Weet u zeker dat u dit formulier nogmaals wil versturen?';var external_links_open_new_window='False';var mark_special_links='false';var ajax_noresponse_message='Geen antwoord van de server. Probeer het later nog een keer.';
...
// https://bib.kuleuven.be/portal_javascripts/++resource++jekyll/toggle.js?original=1
jQuery(function($){
...
// https://bib.kuleuven.be/portal_javascripts/++resource++plone.app.jquerytools.overlayhelpers.js?original=1
...
/* - modernizr.js - */
// https://bib.kuleuven.be/portal_javascripts/modernizr.js?original=1
...
/* - nodeutilities.js - */
// https://bib.kuleuven.be/portal_javascripts/nodeutilities.js?original=1
...
/* - cookie_functions.js - */
// https://bib.kuleuven.be/portal_javascripts/cookie_functions.js?original=1
...
/* - livesearch.js - */
// https://bib.kuleuven.be/portal_javascripts/livesearch.js?original=1
...
/* - ++resource++search.js - */
// https://bib.kuleuven.be/portal_javascripts/++resource++search.js?original=1
...
/* - select_all.js - */
// https://bib.kuleuven.be/portal_javascripts/select_all.js?original=1
...
/* - dragdropreorder.js - */
// https://bib.kuleuven.be/portal_javascripts/dragdropreorder.js?original=1
...
// https://bib.kuleuven.be/portal_javascripts/collapsiblesections.js?original=1
...
// https://bib.kuleuven.be/portal_javascripts/collapsibleformfields.js?original=1
...
// https://bib.kuleuven.be/portal_javascripts/++resource++plone.app.discussion.javascripts/comments.js?original=1
...
/* - form_tabbing.js - */
// https://bib.kuleuven.be/portal_javascripts/form_tabbing.js?original=1
...
/* - popupforms.js - */
// https://bib.kuleuven.be/portal_javascripts/popupforms.js?original=1
...
// https://bib.kuleuven.be/portal_javascripts/jquery.highlightsearchterms.js?original=1
...
// https://bib.kuleuven.be/portal_javascripts/first_input_focus.js?original=1
jq(function(){if(jq("form div.error :input:first").focus().length) return;if(jq("form.enableAutoFocus :input.firstToFocus:first").focus().length) return;jq("form.enableAutoFocus :input:not(.formTabs):visible:first").focus()});

/* - accessibility.js - */
// https://bib.kuleuven.be/portal_javascripts/accessibility.js?original=1
...
/* - styleswitcher.js - */
// https://bib.kuleuven.be/portal_javascripts/styleswitcher.js?original=1
...
/* - toc.js - */
// https://bib.kuleuven.be/portal_javascripts/toc.js?original=1
...
/* - dropdown.js - */
// https://bib.kuleuven.be/portal_javascripts/dropdown.js?original=1
